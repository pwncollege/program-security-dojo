...
int main(int argc, char **argv, char **envp)
{
    ...
    shellcode = mmap((void *)0x1bc4d000, 0x1000, PROT_READ|PROT_WRITE|PROT_EXEC, MAP_PRIVATE|MAP_ANON, 0, 0);
    assert(shellcode == (void *)0x1bc4d000);
    printf("Mapped 0x1000 bytes for shellcode at %p!\n", shellcode);

    puts("Reading 0x12 bytes from stdin.\n");
    shellcode_size = read(0, shellcode, 0x12);
