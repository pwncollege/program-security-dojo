...
int main(int argc, char **argv, char **envp)
{
    ...
    shellcode = mmap((void *)0x15093000, 0x1000, PROT_READ|PROT_WRITE|PROT_EXEC, MAP_PRIVATE|MAP_ANON, 0, 0);
    assert(shellcode == (void *)0x15093000);
    printf("Mapped 0x1000 bytes for shellcode at %p!\n", shellcode);

    puts("Reading 0xc bytes from stdin.\n");
    shellcode_size = read(0, shellcode, 0xc);
